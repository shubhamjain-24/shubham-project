        ...
        <div className="LearnMore_flexDiv">
          <div className="LearnMore_textDiv">
            <div className="Learnmore_text">
              A brand built on a deep-rooted commitment to nature and
              sustainability. Today, we stand as a beacon of hope for
              eco-conscious consumers who seek not just the products, but a
