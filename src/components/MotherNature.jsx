      ...
      <div className="w-full h-full">
        ...
        <div className="flex justify-between gap-5 lg:mt-20 mt-10 flex-wrap md:flex-nowrap h-fit w-full">
              ...
              <div className="relative cursor-pointer overflow-hidden">
                ...
                {firsttintOpen ? (
                  <div className="h-full w-full">
                    <div className="absolute backdrop-brightness-0 h-full w-full duration-500 top-0 right-0  opacity-30 rounded-b-none overflow-hidden cursor-pointer" />
          ...
          >
            ...
            <div className="mt-1 flex justify-center flex-col items-center gap-2 p-2">
              <h4 className="text-3xl md:text-2xl font-semibold">Home Essentials</h4>
              <p className="text-gray-800 text-lg md:text-center">
                Feminine Grace in Sustainable Threads
              </p>
            </div>
